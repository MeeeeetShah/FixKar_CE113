...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2022 at 04:22 PM
...
(1, 'Meet Shah', 'shahmeetjayendrakumar@gmail.com', 'Meet@2008');
...
(1, 'Keyboards', '2022-06-09', 5, 5, 500, 750);
...
CREATE TABLE `requesterlogin_tb` (
  ...
  `r_password` varchar(50) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(1, ' Meet Shah', 'shahmeet852@gmail.com', '2345'),
(2, 'mann shAH', 'Shahmegha852@gmail.com', 'meetshah');
...
(1, 'Ramu', 'Ahmedabad', 1234554321, 'ramu@gmail.com');
